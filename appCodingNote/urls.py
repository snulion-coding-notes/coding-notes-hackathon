...
urlpatterns = [
    ...
    path('dashboard/readbookmark/', views.Bookmarking.read_bookmark, name='read_bookmark'),
    path('dashboard/createbookmark/', views.Bookmarking.create_bookmark, name='create_bookmark'),
    path('dashboard/createtag/', views.Tagging.create_tag, name='create_tag'),
